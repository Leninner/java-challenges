...
public class CajeroAutomatico {
  public static void main(String[] args) {
    ...
    int typeAction = Integer.parseInt(JOptionPane.showInputDialog("¿Qué tipo de operación deseas realizar? (Retiro(1), Depósito(2) o Consultar saldo(3))"));
    ...
    switch(typeAction){
      case 1: 
        ...
        if(money > MAX_AMOUNT){
          ...
          JOptionPane.showMessageDialog(null, "Retiro exitoso " + nameClient + ", tu saldo actual es de: " + (MAX_AMOUNT - money));
        }
      break;
      ...
      case 2:
        ...
        JOptionPane.showMessageDialog(null, "Depósito exitoso " + nameClient + ", tu saldo actual es de: " + (MAX_AMOUNT + moneyDeposit));
      break;
